...
[![GitHub license](https://img.shields.io/github/license/mashape/apistatus.svg)](https://github.com/dhrumeshgandhi/material-dialogs/blob/master/LICENSE.txt)

![Screenshots](https://raw.githubusercontent.com/afollestad/material-dialogs/master/art/readmeshowcase.png)

# Table of Contents (Core)

1. [Sample Project](https://github.com/dhrumeshgandhi/material-dialogs#sample-project)
2. [Gradle Dependency](https://github.com/dhrumeshgandhi/material-dialogs#gradle-dependency)
    1. [Repository](https://github.com/dhrumeshgandhi/material-dialogs#repository)
    2. [Core](https://github.com/dhrumeshgandhi/material-dialogs#core)
    3. [Commons](https://github.com/dhrumeshgandhi/material-dialogs#commons)
3. [What's New](https://github.com/dhrumeshgandhi/material-dialogs#whats-new)
4. [Basic Dialog](https://github.com/dhrumeshgandhi/material-dialogs#basic-dialog)
5. [Dismissing Dialogs](https://github.com/dhrumeshgandhi/material-dialogs#dismissing-dialogs)
6. [Displaying an Icon](https://github.com/dhrumeshgandhi/material-dialogs#displaying-an-icon)
7. [Stacked Action Buttons](https://github.com/dhrumeshgandhi/material-dialogs#stacked-action-buttons)
    1. [Stacking Behavior](https://github.com/dhrumeshgandhi/material-dialogs#stacking-behavior)
8. [Neutral Action Button](https://github.com/dhrumeshgandhi/material-dialogs#neutral-action-button)
9. [Callbacks](https://github.com/dhrumeshgandhi/material-dialogs#callbacks)
10. [CheckBox Prompts](https://github.com/dhrumeshgandhi/material-dialogs#checkbox-prompts)
11. [List Dialogs](https://github.com/dhrumeshgandhi/material-dialogs#list-dialogs)
12. [Single Choice List Dialogs](https://github.com/dhrumeshgandhi/material-dialogs#single-choice-list-dialogs)
    1. [Coloring Radio Buttons](https://github.com/dhrumeshgandhi/material-dialogs#coloring-radio-buttons)
13. [Multi Choice List Dialogs](https://github.com/dhrumeshgandhi/material-dialogs#multi-choice-list-dialogs)
    1. [Coloring Check Boxes](https://github.com/dhrumeshgandhi/material-dialogs#coloring-check-boxes)
14. [Assigning IDs to List Item Views](https://github.com/dhrumeshgandhi/material-dialogs#assigning-ids-to-list-item-views)
15. [Custom List Dialogs](https://github.com/dhrumeshgandhi/material-dialogs#custom-list-dialogs)
16. [Custom Views](https://github.com/dhrumeshgandhi/material-dialogs#custom-views)
    1. [Later Access](https://github.com/dhrumeshgandhi/material-dialogs#later-access)
17. [Typefaces](https://github.com/dhrumeshgandhi/material-dialogs#typefaces)
18. [Getting and Setting Action Buttons](https://github.com/dhrumeshgandhi/material-dialogs#getting-and-setting-action-buttons)
19. [Theming](https://github.com/dhrumeshgandhi/material-dialogs#theming)
    1. [Basics](https://github.com/dhrumeshgandhi/material-dialogs#basics)
    2. [Colors](https://github.com/dhrumeshgandhi/material-dialogs#colors)
    3. [Selectors](https://github.com/dhrumeshgandhi/material-dialogs#selectors)
    4. [Gravity](https://github.com/dhrumeshgandhi/material-dialogs#gravity)
    5. [Material Palette](https://github.com/dhrumeshgandhi/material-dialogs#material-palette)
20. [Global Theming](https://github.com/dhrumeshgandhi/material-dialogs#global-theming)
21. [Show, Cancel, and Dismiss Callbacks](https://github.com/dhrumeshgandhi/material-dialogs#show-cancel-and-dismiss-callbacks)
22. [Input Dialogs](https://github.com/dhrumeshgandhi/material-dialogs#input-dialogs)
    1. [Coloring the EditText](https://github.com/dhrumeshgandhi/material-dialogs#coloring-the-edittext)
    2. [Limiting Input Length](https://github.com/dhrumeshgandhi/material-dialogs#limiting-input-length)
    3. [Custom Invalidation](https://github.com/dhrumeshgandhi/material-dialogs#custom-invalidation)
23. [Progress Dialogs](https://github.com/dhrumeshgandhi/material-dialogs#progress-dialogs)
    1. [Proguard](https://github.com/dhrumeshgandhi/material-dialogs#proguard)
    2. [Indeterminate Progress Dialogs](https://github.com/dhrumeshgandhi/material-dialogs#indeterminate-progress-dialogs)
    3. [Determinate (Seek Bar) Progress Dialogs](https://github.com/dhrumeshgandhi/material-dialogs#determinate-seek-bar-progress-dialogs)
    4. [Make an Indeterminate Dialog Horizontal](https://github.com/dhrumeshgandhi/material-dialogs#make-an-indeterminate-dialog-horizontal)
    5. [Coloring the Progress Bar](https://github.com/dhrumeshgandhi/material-dialogs#coloring-the-progress-bar)
    6. [Custom Number and Progress Formats](https://github.com/dhrumeshgandhi/material-dialogs#custom-number-and-progress-formats)
24. [Tint Helper](https://github.com/dhrumeshgandhi/material-dialogs#tint-helper)
25. [Misc](https://github.com/dhrumeshgandhi/material-dialogs#misc)

# Table of Contents (Commons)

1. [Color Chooser Dialogs](https://github.com/dhrumeshgandhi/material-dialogs#color-chooser-dialogs)
    1. [Finding Visible Dialogs](https://github.com/dhrumeshgandhi/material-dialogs#finding-visible-dialogs)
    2. [User Color Input](https://github.com/dhrumeshgandhi/material-dialogs#user-color-input)
2. [File Selector Dialogs](https://github.com/dhrumeshgandhi/material-dialogs#file-selector-dialogs)
3. [Folder Selector Dialogs](https://github.com/dhrumeshgandhi/material-dialogs#folder-selector-dialogs)
4. [Preference Dialogs](https://github.com/dhrumeshgandhi/material-dialogs#preference-dialogs)
5. [Simple List Dialogs](https://github.com/dhrumeshgandhi/material-dialogs#simple-list-dialogs) 

------

# Sample Project

You can download the latest sample APK from this repo here: https://github.com/dhrumeshgandhi/material-dialogs/blob/master/sample/sample.apk
...
### [View Releases](https://github.com/dhrumeshgandhi/material-dialogs/releases)
